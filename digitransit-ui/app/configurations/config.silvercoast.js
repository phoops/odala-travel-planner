...
export default {
  ...
  contactName: {
    sv: 'Life for Silver Coast',
    fi: 'Life for Silver Coast',
    default: 'Life for Silver Coast',
  },

  APP_PATH: `${APP_PATH}`,
  title: 'Life for Silver Coast',

  availableLanguages: ['it', 'en'],
  defaultLanguage: 'it',

  favicon: './app/configurations/images/silvercoast/favicon.ico',

  // Navbar logo
  logo: 'silvercoast/logo.jpeg',
  ...
  appBarLink: {
    name: 'Life for Silver Coast',
    href: 'https://www.lifeforsilvercoast.eu',
  },
  ...
  footer: {
    content: [
      { label: `© Life for Silver Coast ${YEAR}` },
      {
        name: 'accessibility',
    ...
    en: [
      {
        ...
        paragraphs: [
          'Welcome to the Journey Planner! The Journey Planner shows you how to get to your destination fast and easy by public transport in Tuscany. You can also use the planner to find fast walking and cycling routes, and to an extent, for driving directions. The Journey Planner is based on the Digitransit service platform.',
        ],
      },
      {
        header: 'Data sources',
    ...
    it: [
      {
        ...
        paragraphs: [
          'Benvenuto nel travel planner di Life for Silver Coast! Il travel planner ti aiuta a dirigerti verso la tua destinazione in modo semplice e veloce utlizzando il trasporto della Toscana. Il travel planner è basato sulla piattaforma Digitransit.',
        ],
      },
      {
        header: 'Data sources',
        ...
        it: [
          {
            type: 'text',
            content:
              "Per migliorare l'esperienza di navigazione delle pagine e di fruizione dei servizi online, questo sito utilizza cookie tecnici e analitici. Maggiori informazioni sui cookie dei siti di gestiti da Life for Silver Coast: ",
          },
          {
            type: 'a',
            content: 'Note legali',
